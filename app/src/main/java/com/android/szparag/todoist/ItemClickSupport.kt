...
class ItemClickSupport private constructor(private val mRecyclerView: RecyclerView) {
  ...
  private val mOnLongClickListener = OnLongClickListener { v ->
    if (mOnItemLongClickListener != null) {
      val holder = mRecyclerView.getChildViewHolder(v)
      return@OnLongClickListener mOnItemLongClickListener!!.onItemLongClicked(mRecyclerView, holder.adapterPosition,
        v)
    }
    false
  }
  ...
  init {
    mRecyclerView.setTag(R.id.item_click_support, this) //todo: 1
